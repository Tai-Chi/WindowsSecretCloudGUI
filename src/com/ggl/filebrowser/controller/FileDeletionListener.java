...
public class FileDeletionListener implements TreeSelectionListener {

    private BrowserModel model;
    private CenterButtonPanel centerPanel;
 
    public FileDeletionListener(BrowserModel model, CenterButtonPanel centerPanel) {
        this.model = model;
    ...
    public void valueChanged(TreeSelectionEvent event) {
    	centerPanel.unsetSyncPath(event.getPath());
